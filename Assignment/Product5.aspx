<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Product5.aspx.cs" Inherits="Assignment.Product5" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:PlaceHolder runat="server" ID="Product" Visible="true">
    <h3>Product List:</h3>
        <br />
    <asp:Repeater ID="ProductList" runat="server" DataSourceID="SqlDataSource1">
        ...
        <ItemTemplate>
            <li>
              <div class="img">
                  <a href="<%#Eval("Product_ID","Product5.aspx?Id={0}") %>">
                   <asp:Image runat="server" ImageUrl=<%#("images/ProductImages/")+Eval("Product_ID") + ".jpg"%> />
                      </a>
                   </div>
                   <div class="info">
                   <a class="title" href="<%#Eval("Product_ID","Product5.aspx?Id={0}") %>"> <%#Eval("Product_Name") %></a>     
                   <div class="price">               
                  <a class="st" href="<%#Eval("Product_ID","Product5.aspx?Id={0}") %>">$<%#string.Format("{0:n2}",Eval("Product_Price")) %></a></div>
              </div>
            </li>
        </ItemTemplate>
        ...
        <asp:PlaceHolder runat="server" ID="ShowProduct" Visible="true">
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Product_ID" DataSourceID="SqlDataSource1" Width="949px">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:db_1624964_co5027_asg_aConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE ([Product_ID] = @Product_ID)">
            <SelectParameters>
                <asp:QueryStringParameter Name="Product_ID" QueryStringField="Id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <asp:DropDownList ID="DDLQuantity" runat="server" DataTextField="Product_Quantity" CssClass="Button" DataSourceID="SqlDataSource1">
